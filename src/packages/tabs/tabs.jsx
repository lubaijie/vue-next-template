...
import VcTabs, { TabPane } from 'ant-design-vue/components/vc-tabs/src';
import TabContent from 'ant-design-vue/components/vc-tabs/src/TabContent';
import { isFlexSupported } from 'ant-design-vue/components/_util/styleChecker';
import PropTypes from 'ant-design-vue/components/_util/vue-types';
import {
  getComponent,
  getOptionProps,
  filterEmpty,
  ...
  getPropsData,
  getSlot,
} from 'ant-design-vue/components/_util/props-util';
import { cloneElement } from 'ant-design-vue/components/_util/vnode';
import isValid from 'ant-design-vue/components/_util/isValid';
import { ConfigConsumerProps } from 'ant-design-vue/components/config-provider';
...
export default {
  ...
  props: {
    ...
    activeKey: PropTypes.oneOfType([PropTypes.string, PropTypes.number, PropTypes.any]),
